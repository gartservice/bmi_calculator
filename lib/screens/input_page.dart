...
class _InputPageState extends State<InputPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('BMI CALCULATOR input'),
      ),
      body: Column(
        children: [
          Expanded(
          ...
          Navigator.pushNamed(context, '/resultPage', arguments: ResultArguments(bmiResult: calc.calculateBMI(), resultText: calc.getResult(), interpretation: calc.getInterpretation()));
          },
            text: 'CALCULATE',
          )
        ],
